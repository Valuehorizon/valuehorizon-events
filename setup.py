# -*- encoding: utf-8 -*-
"""
Python setup file for the events app.
...
events/__init__.py and re-run the above command.
...
setup(
    ...
    test_suite="events.tests.runtests.runtests"
)
